...
public final class FederatedIdentityConfigurer extends AbstractHttpConfigurer<FederatedIdentityConfigurer, HttpSecurity> {
    ...
    private OAuthConsumer<OAuth2User> oauth2UserHandler;

    private OAuthConsumer<OidcUser> oidcUserHandler;
    ...
    public FederatedIdentityConfigurer oauth2UserHandler(OAuthConsumer<OAuth2User> oauth2UserHandler) {
        Assert.notNull(oauth2UserHandler, "oauth2UserHandler cannot be null");
        this.oauth2UserHandler = oauth2UserHandler;
        return this;
    }

    public FederatedIdentityConfigurer oidcUserHandler(OAuthConsumer<OidcUser> oidcUserHandler) {
    ...
    public void init(HttpSecurity http) throws Exception {
        ...
        // Repository with registered Google and GitHub clients
